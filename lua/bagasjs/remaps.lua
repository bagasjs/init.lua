...
map("n", "<C-|>", "<C-W>s", { desc = "Split window horizontally", remap = true })
map("n", "<C-_>", "<C-W>v", { desc = "Split window vertically", remap = true })
...
map("n", "<leader><tab><space>", "<CMD>tabnew<CR><CMD>terminal<CR>", { desc = "Open Terminal in new Tab" })
map("t", "<ESC>", "<C-\\><C-n>")
